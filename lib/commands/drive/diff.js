...
Examples:
  ...
  bit drive diff bit://1234..af/ ./local-folder
  bit drive diff ./local-folder bit://1234..af/remote-folder --no-delete
  bit drive diff bit://1234..af/ bit://fedc..21/ --commit
`

export default {
  name: 'drive diff',
  description: 'Compare two folders in your local filesystem or in bitdrives. Can optionally "commit" the difference.',
  usage: {
