...
export async function setup ({canStartDaemon} = {canStartDaemon: false}) {
  await setupClient('bitspace', 'Bitspace', () => new BitspaceClient(), canStartDaemon)
  await setupClient('bitspace-mirroring-service', 'Mirroring', () => new MirroringClient(), canStartDaemon)
}
...
export function getClient () {
  return clients.get('bitspace')
}

export function getMirroringClient () {
  return clients.get('bitspace-mirroring-service')
}
